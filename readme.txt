...
* Minor update to fix an obscure cirumstance where members using one of their social network identities to login to the WordPress site may not be authenticated correctly

= 1.0.2 = 
* Strenghtened the check to insure all access is removed in the WordPress site if the member's login access is deactivated completely in their memebr record in Membee
